...
description: Due to the modular nature of the system, users can run or even implement their own components.
---
...
This is expected to be a common scenario: the implementations provided by Openfort are self-hosted,
...
configuring automatic recovery. **Using 2FA is strongly recommended to protect user accounts in this scenario.**
:::
