...
:::info
The signup diagrams shows data being moved inside the in process or to local storage with continous lines, and the data
potentially being transmitted over a network with dashed lines.

<img src="/diagrams/conn_legend.svg" alt="Connection legent" width="60%" style={{ display: "block", margin: "auto" }}/>
:::
