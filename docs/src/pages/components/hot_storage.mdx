...
description: Technical guide to the OpenSigner hot storage component for storing frequently accessed key shares, with device linking, JWT auth, and Go implementation.
---
...
<JsonLd data={techArticle({ headline: 'Hot storage component', description: 'Technical guide to the OpenSigner hot storage component for storing frequently accessed key shares, with device linking, JWT auth, and Go implementation.', path: '/components/hot_storage' })} />
