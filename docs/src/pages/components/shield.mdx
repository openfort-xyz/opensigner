...
<JsonLd data={techArticle({ headline: 'Shield component', description: 'Explore the OpenSigner Shield cold storage component built in Go with MySQL, supporting password, passkey, and automatic recovery with OTP for key shares.', path: '/components/shield' })} />
