...
For an overview of the threat model these checks defend against, see [Threat analysis](/security/threat-analysis); for the broader security architecture, see [Security overview](/security/overview).
...
The Shield image powers the [cold storage component](/components/shield); the iframe assets covered below are loaded by the [iFrame component](/components/iframe).
