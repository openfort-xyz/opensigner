...
> 
> It's never a fun experience to have your pull request declined after investing time and effort into a new feature. To avoid this from happening, we request that contributors create a [feature request](https://github.com/openfort-xyz/opensigner/discussions/new?category=ideas) to first discuss any API changes or significant new ideas.
...
Documentation is crucial to helping developers of all experience levels. OpenSigner itself and Markdown for the documentation site (located at [`site`](../site)). To start the site in dev mode, run:
...
<div>
  ✅ Now you're ready to contribute to OpenSigner!
</div>
